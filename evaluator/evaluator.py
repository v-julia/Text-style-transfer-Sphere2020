...
class Evaluator(object):
    ...
    def __init__(self, acc_path='pushkin_cvetaeva_new.bin', ppl_path='poets_5_kenlm.binary', pos_label = '__label__positive'):
    ...
    def yelp_style_check(self, text_transfered, style_origin):
        ...
        style_transfered = label[0][0] == self.pos_label
